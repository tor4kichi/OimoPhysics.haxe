...
class Hinge2Joint extends Joint
{
    ...
    /**
		 ...
		 */
    public var enableLimits1 : Bool;
    
    /**
		 * 剛体1の回転軸に対する可動範囲の下限です。
		 * enableLimits1 が true の時にのみ有効になります。
		 */
    public var lowerLimit1 : Float;
    
    /**
		 * 剛体1の回転軸に対する可動範囲の上限です。
		 * enableLimits1 が true の時にのみ有効になります。
		 */
    public var upperLimit1 : Float;
    ...
    /**
		 * 剛体1の回転軸に対する可動範囲の制限が有効であるかどうかを表します。
		 */
    public var enableLimits2 : Bool;
    
    /**
		 * 剛体1の回転軸に対する可動範囲の下限です。
		 * enableLimits1 が true の時にのみ有効になります。
		 */
    public var lowerLimit2 : Float;
    
    /**
		 * 剛体1の回転軸に対する可動範囲の上限です。
		 * enableLimits1 が true の時にのみ有効になります。
		 */
    public var upperLimit2 : Float;
    ...
    /**
		 ...
		 */
    public var enableMotor1 : Bool;
    
    /**
		 * 剛体1の回転軸に対するモーターの速度です。
		 * enableMotor1 が true の時にのみ有効になります。
		 */
    public var motorSpeed1 : Float;
    
    /**
		 * 剛体1の回転軸に対するモーターの最大のトルクです。
		 * enableMotor1 が true の時にのみ有効になります。
		 */
    public var maxMotorTorque1 : Float;
    
    private var stepMotorTorque1 : Float;
    
    /**
		 * 剛体2の回転軸に対するモーターが有効であるかどうかを表します。
		 */
    public var enableMotor2 : Bool;
    
    /**
		 * 剛体2の回転軸に対するモーターの速度です。
		 * enableMotor2 が true の時にのみ有効になります。
		 */
    public var motorSpeed2 : Float;
    
    /**
		 * 剛体2の回転軸に対するモーターの最大のトルクです。
		 * enableMotor2 が true の時にのみ有効になります。
		 */
    public var maxMotorTorque2 : Float;
    
    private var stepMotorTorque2 : Float;
    ...
    private var invTanDenominator : Float;
    private var invBinDenominator : Float;
    ...
    override public function preSolve(timeStep : Float, invTimeStep : Float) : Void{
        ...
        if (
            tanX != 0 * (angAxis1Y != 0 * binZ != 0 - angAxis1Z != 0 * binY != 0) +
            tanY != 0 * (angAxis1Z != 0 * binX != 0 - angAxis1X != 0 * binZ != 0) +
        ...
        if (
            binX != 0 * (angAxis2Y != 0 * tanZ != 0 - angAxis2Z != 0 * tanY != 0) +
            binY != 0 * (angAxis2Z != 0 * tanX != 0 - angAxis2X != 0 * tanZ != 0) +
    ...
    override public function solve() : Void{
        ...
        var newTorqueNor : Float;
        var newTorqueTan : Float;
        var newTorqueBin : Float;
        var oldMotorTorque1 : Float;
        var newMotorTorque1 : Float;
        var oldLimitTorque1 : Float;
        var newLimitTorque1 : Float;
        var oldMotorTorque2 : Float;
        var newMotorTorque2 : Float;
        var oldLimitTorque2 : Float;
        var newLimitTorque2 : Float;
